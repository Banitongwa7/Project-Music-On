...
$statement->execute();
$nbr_music = $statement->rowCount();
$nbr_music_page = 5;
$mid_page = ceil($nbr_music / $nbr_music_page);

$resultat = $statement->fetchAll();
if (isset($_GET["page"]) && ($_GET["page"] > 0) && (!empty($_GET["page"]) && ($_GET["page"] <= $mid_page)))
{
  $page = $_GET["page"];
}
else
...
$debut = ($page - 1)* $nbr_music_page;
$query = "select * from musique limit ".$debut.','.$nbr_music_page;
$statement = $connect->prepare($query);
$statement->execute();
$resultat = $statement->fetchAll();
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item ppl">
            <a class="nav-link" href="gallery_music.php">Playlist</a>
          </li>
  ...
  <section>
    ...
    <div class="container2">
      ...
      ?>
        <div class="box">
          <div class="image">
            <img src="../IMAGES/image_player/<?=$row["image"]?>" alt="music 1">
          </div>
          <div class="music">
          <p class="titrech">Titre : <?=$row["titre"] ?> <br> Categorie : <?=$row["categorie"] ?></p>
            <audio src="../MUSIC/<?= $row["audio"] ?>" controls></audio>
          </div>
        </div>
      <?php
      }
    ...
    <div class="pag">
      <ul class="pagination justify-content-center">
        <?php
        for($page=1;$page<=$mid_page;$page++)
        {
        ?>
        <li class="page-item"><a class="page-link" href="gallery_music.php?page=<?=$page?>" ><?=$page?></a></li>
        <?php
        }
        ?>
      </ul>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 item text">
            ...
            <form action="gallery_music.php" method="post">
